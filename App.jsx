...
// --- 1. KEAMANAN & INISIALISASI DATABASE ---
...
try {
  ...
  idAplikasi = typeof __app_id !== 'undefined' ? __app_id : 'aplikasi-aiku-prod';
} catch (e) {
  console.warn("Berjalan dalam mode lokal.");
}

// --- 2. PENGAMANAN API KEY GEMINI ---
// Kunci diambil dari environment variable Vercel sehingga aman dari publik
const KUNCI_API_GEMINI = (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_GEMINI_API_KEY) 
  ? import.meta.env.VITE_GEMINI_API_KEY 
  : "";

// --- 3. FUNGSI PEMFORMATAN TEKS (MARKDOWN) ---
...
export default function App() {
  const pesanAwalDefault = { peran: 'ai', teks: 'Halo! Saya AIKU, asisten pintar Anda. Kirimkan pesan, foto, atau video untuk mulai berdiskusi.' };
  ...
  const panggilAPI = async (riwayatPesan) => {
    const url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-09-2025:generateContent?key=" + KUNCI_API_GEMINI;
